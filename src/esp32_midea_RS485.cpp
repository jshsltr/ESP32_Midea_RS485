...
uint8_t ESP32_Midea_RS485Class::ParseResponse()
{
    ...
    )
    {
        ...
        State.T1Temp = 0xFF;//(ReceivedData[0x0B]-0x30)/2;        
        State.T2ATemp = 0xFF;//(ReceivedData[0x0C]-0x30)/2;        
        State.T2BTemp = 0xFF;//(ReceivedData[0x0D]-0x30)/2;        
        State.T3Temp = 0xFF;//(ReceivedData[0x0E]-0x30)/2;
...
ESP32_Midea_RS485Class ESP32_Midea_RS485(DEFAULT_SERIAL_COM_BUS,DEFAULT_SERIAL_COM_RO_PIN,DEFAULT_SERIAL_COM_DI_PIN,DEFAULT_SERIAL_COM_MASTER_ID,DEFAULT_SERIAL_COM_SLAVE_ID,DEFAULT_SERIAL_COM_MASTER_SEND_TIME,DEFAULT_SERIAL_COM_SLAVE_TIMEOUT_TIME);
